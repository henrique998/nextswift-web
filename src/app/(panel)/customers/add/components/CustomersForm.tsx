...
const addCustomerFormValidationSchema = zod.object({
  name: zod.string(),
  email: zod.string(),
...
type AddCustomerFormData = zod.infer<typeof addCustomerFormValidationSchema>
...
export function CustomersForm() {
  ...
  const { handleSubmit, register, reset } = useForm<AddCustomerFormData>({
    resolver: zodResolver(addCustomerFormValidationSchema),
  })
